...
curl -o bind/db.internal.wt1.ephec-ti.be https://raw.githubusercontent.com/Frodon001/2tl2AdminGr10/master/serv_dns/DNS/bind/db.internal.wt1-9.ephec-ti.be
curl -o bind/db.wt1.ephec-ti.be https://raw.githubusercontent.com/Frodon001/2tl2AdminGr10/master/serv_dns/DNS/bind/db.wt1-9.ephec-ti.be
